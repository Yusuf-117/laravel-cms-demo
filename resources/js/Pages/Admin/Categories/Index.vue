    ...
    <AdminLayout>
        <div class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <Link v-if="canEdit" :href="route('categories.create')"
            ...
            <div class="flex items-center gap-3">
                <input v-model="search" placeholder="Search categories..."
                    class="w-full sm:w-80 px-4 py-2 rounded-lg border border-zinc-300 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-black dark:bg-zinc-900 dark:border-zinc-700 dark:focus:ring-white" />
            </div>
                    ...
                    <tbody>
                        <tr v-for="c in categories.data" :key="c.id"
                            ...
                            <td class="px-6 py-4 text-right space-x-3">
                                ...
                                <button v-if="canEdit" @click="destroy(c.id)"
            ...
            <div class="flex flex-wrap gap-2">
                <Link v-for="link in categories.links" :key="link.label" :href="link.url || ''" v-html="link.label"
                    class="px-3 py-1.5 rounded-md text-sm border border-zinc-300 hover:bg-zinc-100 dark:border-zinc-700 dark:hover:bg-zinc-800"
                    :class="{
