...
<template>
  <DocsLayout :categories="categories">
    <div class="space-y-8">
      <section class="rounded-3xl border border-zinc-200 bg-gradient-to-br from-white to-zinc-50 p-8 dark:border-zinc-800 dark:from-zinc-900 dark:to-zinc-950">
        <div class="max-w-3xl">
        ...
        <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          ...
          >
            ...
            <div class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
              {{ category.published_articles_count }} article<span v-if="category.published_articles_count !== 1">s</span>
            </div>
          </Link>
        </div>
      </section>
