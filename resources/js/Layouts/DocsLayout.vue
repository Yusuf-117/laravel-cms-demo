...
<template>
    <div class="min-h-screen bg-[var(--docs-bg)] text-[var(--docs-text)]">
        <div class="grid min-h-screen grid-cols-[260px_minmax(0,1fr)]">
            <aside class="border-r border-[var(--docs-border)] bg-[var(--docs-panel)]">
                <div class="flex h-14 items-center border-b border-[var(--docs-border)] px-4">
                    <Link :href="route('home')" class="text-lg font-semibold tracking-tight text-[var(--docs-text)]">
                        Knowledge Archive
                    </Link>
                </div>
                    ...
                    <div class="space-y-1">
                        <div v-for="cat in categories" :key="cat.id" class="space-y-1">
                            ...
                            <div v-show="open[`cat-${cat.id}`]" class="space-y-1 pl-3">
                                <Link v-for="a in cat.articles || []" :key="a.id"
                                ...
                                <div v-for="child in cat.children || []" :key="child.id" class="space-y-1">
                        ...
                        <aside class="space-y-6 pt-2">
                            <div v-if="headings.length">
                                ...
                                <div class="space-y-2 text-sm">
                                    <a v-for="h in headings" :key="h.id" :href="'#' + h.id"
                                        class="block transition hover:text-[var(--docs-primary)]" :class="[
                                            h.level === 2
                            ...
                            <div
                                ...
                                <div class="rounded-[11px] bg-[var(--docs-primary)]/95 p-5">
                                    ...
                                    <a href="https://yusufibrahim.co.uk" type="button"
