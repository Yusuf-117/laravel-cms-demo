...
function buildToc() {
    const els = document.querySelectorAll(".docs-prose h2, .docs-prose h3");
...
<template>
    <div class="min-h-screen bg-[var(--docs-bg)] text-[var(--docs-text)]">
        <div class="grid min-h-screen grid-cols-[260px_minmax(0,1fr)]">
            <aside
                class="border-r border-[var(--docs-border)] bg-[var(--docs-panel)]"
            >
                <div
                    class="flex h-14 items-center border-b border-[var(--docs-border)] px-4"
                >
                    <Link
                        :href="route('home')"
                ...
                <div class="px-4 pb-6 pt-4">
                    <div
                        class="mb-6 text-[10px] uppercase tracking-[0.24em] text-[var(--docs-muted)]"
                    >
                        Demo
                    </div>
            ...
            <div class="min-w-0 bg-[var(--docs-bg)]">
                ...
                <main class="px-8 py-7 xl:px-10">
                    <div
                        class="mb-4 text-[11px] uppercase tracking-[0.22em] text-[var(--docs-muted)]"
                    >
                        Documentation
                        <span class="mx-2 text-[var(--docs-border-strong)]"
                            >›</span
                        >
                    ...
                    <div class="mb-8 max-w-4xl">
                        <h1
                            class="text-5xl font-black leading-[0.95] tracking-[-0.04em] text-[var(--docs-text)]"
                        >
                            {{ article?.title }}
                        </h1>

                        <div
                            class="mt-5 flex flex-wrap items-center gap-3 text-sm text-[var(--docs-muted)]"
                        >
                            <span
                                class="inline-block h-7 w-[2px] rounded-full bg-[var(--docs-primary)]"
                            />
                    ...
                    <div class="grid grid-cols-[minmax(0,1fr)_240px] gap-10">
                        ...
                        <aside class="space-y-6 pt-2">
                            <div v-if="headings.length">
                                <div
                                    class="mb-4 text-[11px] font-semibold uppercase tracking-[0.24em] text-[var(--docs-text)]"
                                >
                                    On this page
                                </div>
                                ...
                                <div class="space-y-2 text-sm">
                                    <a
                                        ...
                                        :key="h.id"
                                        :href="'#' + h.id"
                                        class="block transition hover:text-[var(--docs-primary)]"
                                        :class="[
                                            h.level === 2
                                                ? 'pl-0 font-medium text-[var(--docs-text)]'
                                                : '',
                                            h.level === 3
                                                ? 'pl-4 text-[var(--docs-muted)]'
                                                : '',
                                        ]"
                                    >
                                        {{ h.text }}
                            ...
                            <div
                                class="overflow-hidden rounded-xl bg-gradient-to-br from-[var(--docs-primary)] to-[#d97b7b] p-[1px]"
                            >
                                <div
                                    class="rounded-[11px] bg-[var(--docs-primary)]/95 p-5"
                                >
                                    ...
                                    <div class="mt-2 text-sm text-white/85">
                                        Check out some of the creator's other
                                        projects
                                    </div>

                                    <a href="https://yusufibrahim.co.uk"
                                        type="button"
                                        class="text-center block mt-5 w-full rounded-md bg-white px-4 py-2.5 text-xs font-bold uppercase tracking-[0.22em] text-[var(--docs-primary)]"
                                    >
                                        Visit Page
                                    </a>
                                </div>
